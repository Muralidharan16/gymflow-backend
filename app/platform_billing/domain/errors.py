...
class PlatformBillingErrorCode(str, Enum):
    ...
    PLATFORM_BILLING_READ_API_DISABLED = "PLATFORM_BILLING_READ_API_DISABLED"
...
ERROR_HTTP_STATUS: Mapping[PlatformBillingErrorCode, int] = {
    PlatformBillingErrorCode.PLATFORM_ACCESS_DENIED: 403,
    PlatformBillingErrorCode.PLATFORM_ENTITLEMENT_REQUIRED: 403,
    PlatformBillingErrorCode.PLATFORM_USAGE_LIMIT_REACHED: 409,
    PlatformBillingErrorCode.PLATFORM_PROJECTION_INVALID: 503,
    PlatformBillingErrorCode.PLATFORM_CAPABILITY_UNKNOWN: 403,
    PlatformBillingErrorCode.PLATFORM_BILLING_READ_API_DISABLED: 404,
