...
class PlatformBillingEventType(str, Enum):
    ...
    PAYMENT_FAILED = "platform.billing.payment.failed"
    PAYMENT_RECOVERED = "platform.billing.payment.recovered"
    MANDATE_CHANGED = "platform.billing.mandate.changed"
    DUNNING_STAGE_CHANGED = "platform.billing.dunning.stage_changed"
    RECURRING_BILLING_DUE = "platform.billing.recurring.due"
