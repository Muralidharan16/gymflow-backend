...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument("--duration-seconds",type=int,default=300); ap.add_argument("--interval-seconds",type=int,default=10)
    ...
    try:
        ...
        while time.monotonic()-started < a.duration_seconds:
            ...
            wait(lambda: terminal_snapshot(ids).get("exact_terminal")==20,"durable cycle",30)
