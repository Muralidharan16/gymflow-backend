...
async def test_phase4d0_security_and_scope_guardrails():
    ...
    assert not (REPO_ROOT / "app" / "platform_billing" / "services" / "reconciliation.py").exists()
    assert not (REPO_ROOT / "app" / "platform_billing" / "providers" / "reconciliation.py").exists()
